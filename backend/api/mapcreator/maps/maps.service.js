...
const { assertUserOwnsGameMap, assertUserOwnsMap, cleanupAfterError } = require("../shared/utils/mapcreator.utils.js");
...
async function createMap(userId, gameMapID, title, file) {
    ...
    try {
        ...
        if (!updateSuccess) {
            throw new AppError("A térkép mentése nem sikerült!", 500);
        }
