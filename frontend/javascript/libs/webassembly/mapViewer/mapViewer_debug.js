...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("mapViewer_debug.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("mapViewer_debug.wasm", import.meta.url).href;
}
...
var wasmSourceMapFile = locateFile("mapViewer_debug.wasm.map");
