...
var ASM_CONSTS = {
  96208: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 96259: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 96323: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 96393: ($0) => { console.log('FPS: ' + $0); }
};
