...
var ASM_CONSTS = {
  98232: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 98283: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 98347: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 98417: ($0) => { console.log('FPS: ' + $0); }
};
