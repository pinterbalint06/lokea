...
var ASM_CONSTS = {
  97200: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97251: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97315: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97385: ($0) => { console.log('FPS: ' + $0); }
};
