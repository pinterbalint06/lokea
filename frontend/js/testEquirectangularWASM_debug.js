...
var ASM_CONSTS = {
  88480: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88531: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 88595: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 88665: ($0) => { console.log('FPS: ' + $0); }
};
