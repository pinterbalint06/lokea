...
var ASM_CONSTS = {
  97712: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97763: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97827: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97897: ($0) => { console.log('FPS: ' + $0); }
};
