...
var ASM_CONSTS = {
  88864: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88915: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 88979: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 89049: ($0) => { console.log('FPS: ' + $0); }
};
