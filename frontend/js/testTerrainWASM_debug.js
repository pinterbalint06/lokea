...
var ASM_CONSTS = {
  97616: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97667: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97731: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97801: ($0) => { console.log('FPS: ' + $0); }
};
