...
var ASM_CONSTS = {
  91088: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 91139: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 91203: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 91273: ($0) => { console.log('FPS: ' + $0); }
};
