...
var ASM_CONSTS = {
  102048: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102099: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102163: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102233: ($0) => { console.log('FPS: ' + $0); }
};
