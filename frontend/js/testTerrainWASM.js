...
var ASM_CONSTS = {
  88912: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88963: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 89027: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 89097: ($0) => { console.log('FPS: ' + $0); }
};
