...
var ASM_CONSTS = {
  97168: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97219: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97283: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97353: ($0) => { console.log('FPS: ' + $0); }
};
