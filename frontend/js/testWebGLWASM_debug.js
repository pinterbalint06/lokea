...
var ASM_CONSTS = {
  87664: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 87715: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 87779: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 87849: ($0) => { console.log('FPS: ' + $0); }
};
