...
var ASM_CONSTS = {
  97040: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97091: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97155: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97225: ($0) => { console.log('FPS: ' + $0); }
};
