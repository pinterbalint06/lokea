...
var ASM_CONSTS = {
  98088: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 98139: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 98203: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 98273: ($0) => { console.log('FPS: ' + $0); }
};
