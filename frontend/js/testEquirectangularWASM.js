...
var ASM_CONSTS = {
  90112: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 90163: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 90227: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 90297: ($0) => { console.log('FPS: ' + $0); }
};
