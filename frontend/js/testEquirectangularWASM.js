...
var ASM_CONSTS = {
  95136: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 95187: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 95251: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 95321: ($0) => { console.log('FPS: ' + $0); }
};
