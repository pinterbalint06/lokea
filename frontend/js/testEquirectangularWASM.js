...
var ASM_CONSTS = {
  88512: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88563: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 88627: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 88697: ($0) => { console.log('FPS: ' + $0); }
};
