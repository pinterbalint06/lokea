...
function findWasmBinary() {
  return locateFile('testWebGLWASM.wasm');
}
...
var ASM_CONSTS = {
  95968: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 96019: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 96083: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 96153: ($0) => { console.log('FPS: ' + $0); }
};
