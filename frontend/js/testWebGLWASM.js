...
var ASM_CONSTS = {
  94960: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 95011: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 95075: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 95145: ($0) => { console.log('FPS: ' + $0); }
};
