...
var ASM_CONSTS = {
  97072: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97123: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97187: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97257: ($0) => { console.log('FPS: ' + $0); }
};
