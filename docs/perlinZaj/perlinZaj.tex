...
definíció alapján végezzük: $\vec{a} \cdot \vec{b} = x_{a}\times x_{b} +
    y_{a}\times y_{b} $"fade" vagy "quintic"
\begin{algorithm}
...
egyenlő 0-val $t=0$ és $t=1$ esetén is, így sima, folyamatos átmenet van a
rácsnégyzetei közt.\\
...
felső skaláris szoraztokat és az alsó skaláris szorzatokat. Majd kiszámoljuk a
...
\end{algorithm}
\section{\textbf{F}ractal \textbf{B}rownian \textbf{M}otion (Fraktál zaj)} \newpage
