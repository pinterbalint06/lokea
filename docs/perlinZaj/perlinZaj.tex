...
\begin{algorithm}[H]
    ...
    \Eljaras{PermutaciosTablaGeneral ( \Valtozok{ \setlength\parindent{52pt}PermutaciosTabla:Tömb(1..MaxP:Egész), \\
            \setlength\parindent{52pt}Rand:VéletlenSzámGenerátor}
        )}{
